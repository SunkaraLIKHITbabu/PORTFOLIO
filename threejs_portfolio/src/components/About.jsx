  ...
  <Tilt className='xs:w-[356px] w-full'>
    ...
    >
      ...
      >
        ...
        <h4 className='text-white text-[24px] text-center'>{subtitle}</h4>
        <h5 className='text-white text-[24px] text-center'>{subtitle1}</h5>
        <h5 className='text-white text-[20px] text-center'>{subtitle2}</h5>
      </div>
    </motion.div>
  </Tilt>
);
